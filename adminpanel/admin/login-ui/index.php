	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(login-ui/images/bg.jpg);"><a href="../../index.php" style="display: block; margin-left: 500px; color: white; margin-top: -60px;"><h6>User Login</h6></a>
